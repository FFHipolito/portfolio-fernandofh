    ...
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-indigo-500/30">
        ...
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-4 border-l border-white/10 pl-2 sm:pl-4">
              ...
              <Link
                href="https://linkedin.com/in/fernando-hipólito"
                target="_blank"
                className="text-muted-foreground hover:text-foreground transition-colors"
              >
              ...
              <Link
                href="mailto:fernandofhipolito@gmail.com"
                className="text-muted-foreground hover:text-foreground transition-colors"
              >
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4">
        ...
        <div className="container mx-auto relative z-10 text-center max-w-4xl flex flex-col items-center">
          ...
          <Badge
            variant="default"
            className="mb-6 px-4 py-1 text-sm border-indigo-500/20 bg-indigo-500/10 text-indigo-300"
          >
            {dict.hero.status}
          </Badge>
...
/>
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
            ...
            <span className="text-indigo-400 font-medium">
              {profile?.name || 'Fernando Fontes Hipólito'}
            </span>
            .
            <br />
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex items-center justify-between mb-12">
            ...
            <Link
              href="https://github.com/FFHipolito"
              target="_blank"
              className="hidden sm:inline-flex text-sm text-indigo-400 hover:text-indigo-300 items-center gap-1 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="flex flex-col h-full bg-zinc-900/30 hover:bg-zinc-900/60 border-indigo-500/30 transition-colors group relative overflow-hidden">
              ...
              <div className="relative w-full h-48 overflow-hidden bg-zinc-900/50">
                <Image
                  ...
                  alt={dict.projects.task_manager.title}
                  fill
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <CardTitle className="truncate pr-2 group-hover:text-indigo-400 transition-colors">
                    {dict.projects.task_manager.title}
                  </CardTitle>
                  <Badge
                    variant="default"
                    className="text-[10px] uppercase bg-indigo-500/20 text-indigo-300"
                  >
                    {dict.projects.task_manager.badge}
                  </Badge>
                </div>
                <CardDescription className="line-clamp-2 min-h-[40px]">
                  {dict.projects.task_manager.description}
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-grow pt-0">
                <p className="text-xs text-muted-foreground/80 mt-2">
                  {dict.projects.task_manager.tech}
                </p>
              </CardContent>
              <CardFooter>
                <Link
                  href={dict.projects.task_manager.link}
                  target="_blank"
                  className="w-full"
                >
            ...
            <Card className="flex flex-col h-full bg-zinc-900/30 hover:bg-zinc-900/60 border-indigo-500/30 transition-colors group relative overflow-hidden">
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <CardTitle className="truncate pr-2 group-hover:text-indigo-400 transition-colors">
                    {dict.projects.around.title}
                  </CardTitle>
                  <Badge
                    variant="default"
                    className="text-[10px] uppercase bg-indigo-500/20 text-indigo-300"
                  >
                    {dict.projects.around.badge}
                  </Badge>
                </div>
                <CardDescription className="line-clamp-2 min-h-[40px]">
                  {dict.projects.around.description}
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-grow pt-0">
                <p className="text-xs text-muted-foreground/80 mt-2">
                  {dict.projects.around.tech}
                </p>
              </CardContent>
              <CardFooter>
                <Link
                  href={dict.projects.around.link}
                  target="_blank"
                  className="w-full"
                >
                  <Button variant="default" className="w-full bg-indigo-600 hover:bg-indigo-700">
            ...
            {reposToShow.length > 0 ? (
              reposToShow.map((repo) => (
                <Card
                  key={repo.id}
                  className="flex flex-col h-full bg-zinc-900/30 hover:bg-zinc-900/60 border-zinc-800 transition-colors group overflow-hidden"
                >
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      <CardTitle className="truncate pr-2 group-hover:text-indigo-400 transition-colors">
                  ...
                  <CardContent className="flex-grow pt-0"></CardContent>
                  <CardFooter>
                    <Link href={repo.html_url} target="_blank" className="w-full">
                      <Button
                        variant="outline"
                        className="w-full border-zinc-700 hover:bg-zinc-800 hover:text-white group-hover:border-indigo-500/30"
                      >
      ...
      <footer className="py-12 border-t border-white/5 bg-black" id="contato">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-lg mx-auto">{dict.footer.subtitle}</p>
