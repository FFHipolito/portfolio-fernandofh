...
- **🤖 Fezinho AI Agent**: Um assistente virtual integrado diretamente no portfólio. Desenvolvido com **Vercel AI SDK** e alimentado pelo modelo **Google Gemini (3.1 Flash Lite)**, o "Fezinho" responde perguntas sobre minhas habilidades, trajetória profissional e projetos do GitHub usando contexto dinâmico em tempo real.
...
| **Inteligência Artificial** | Google Gemini (3.1 Flash Lite), Vercel AI SDK |
